...
5. **📍 地名表示・🔍 地名検索**: 図形をタップすると町丁目名(丁目・字)をポップアップに自動表示(国土地理院 逆ジオコーダAPI・全国対応)。左上の🔍から地名・住所検索で地図ジャンプ(国土地理院 住所検索API。ポスター/街宣マップにも搭載)。いずれも無料・キー不要の試験公開APIのため、将来仕様変更の可能性あり
6. **🏠 世帯数レイヤ**: 右上のレイヤボタンから、国勢調査2020・町丁目ごとの世帯数コロプレス+数値ラベルを重ねられる(クリックで町丁目名・世帯数・人口)
